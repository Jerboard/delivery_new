        ...
        if row [13].strip () != '':
            ...
            try:
                await db.add_row (
                    ...
                    q=int (re.sub (r'\D+', '0', row [16])),
                    r=int (re.sub (r'\D+', '0', row [17])),
                    s=int (re.sub (r'\D+', '0', row [18])),
                    t=int (re.sub (r'\D+', '0', row [19])),
                    u=int (re.sub (r'\D+', '0', row [20])),
                    v=int (re.sub (r'\D+', '0', row [21])),
        ...
        try:
            if row [13]:
                ...
                await db.add_report_row (
                    b=int (re.sub (r'\D+', '0', row [1])),
                    c=int (re.sub (r'\D+', '0', row [2])),
                    d=int (re.sub (r'\D+', '0', row [3])),
                    e=int (re.sub (r'\D+', '0', row [4])),
                    f=int (re.sub (r'\D+', '0', row [5])),
                    g=int (re.sub (r'\D+', '0', row [6])),
                    h=int (re.sub (r'\D+', '0', row [7])),
                    i=int (re.sub (r'\D+', '0', row [8])),
                    k=int (re.sub (r'\D+', '0', row [9])),
                    l=l_list,
                    m=row [12].strip (),
                    n=row [13].strip (),
                    o=int (re.sub (r'\D+', '0', row [14])),
                    p=row [15].strip (),
                    q=row [16].strip (),
                    r=int (re.sub (r'\D+', '0', row [17])),
                    updated=True,
